...
uses
  ...
  Vcl.ExtCtrls, Vcl.MPlayer, System.Win.ScktComp{delete library usage}, CGServer_u, CGClient_u;
...
begin
  ...
  With frmServer do     // check to see if username and password is correct or not
    begin
